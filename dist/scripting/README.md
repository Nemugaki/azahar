...
`(enabled_mask, active_event, halted)`. Vertex-shader invocation is a software-shader event; use an
incoming-primitive breakpoint or a one-shot snapshot when hardware shaders are enabled.
